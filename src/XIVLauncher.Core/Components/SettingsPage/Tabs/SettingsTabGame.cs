...
public class SettingsTabGame : SettingsTab
{
    public override SettingsEntry[] Entries { get; } =
    {
        ...
        new SettingsEntry<bool>("Skip XIVLauncher version check", "Don't check for new versions of XIVLauncher (Requires restart)", () => !Program.Config.DoVersionCheck ?? false, b => Program.Config.DoVersionCheck = !b),
    };
