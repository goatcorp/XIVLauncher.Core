...
public class SettingsTabDalamud : SettingsTab
{
    ...
    public SettingsTabDalamud()
    {
        this.Entries = new SettingsEntry[]
        {
            ...
            new DalamudBranchMetaSettingsEntry(Strings.DalamudBranchSwitcher, Strings.DalamudBranchSwitcher, () => Program.Config.DalamudBetaKind ?? "release" , (track) => Program.Config.DalamudBetaKind = track),
