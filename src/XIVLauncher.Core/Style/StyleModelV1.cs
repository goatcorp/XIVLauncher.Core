...
public class StyleModelV1 : StyleModel
{
    ...
    public static StyleModelV1 DalamudStandard => new()
    {
        ...
        ScrollbarRounding = ImGuiHelpers.GetScaled(9),
        GrabMinSize = ImGuiHelpers.GetScaled(13),
        GrabRounding = ImGuiHelpers.GetScaled(3),
        LogSliderDeadzone = ImGuiHelpers.GetScaled(4),
        TabRounding = ImGuiHelpers.GetScaled(1),
        TabBorderSize = 0,
    ...
    public static StyleModelV1 DalamudClassic => new()
    {
        ...
        ScrollbarSize = ImGuiHelpers.GetScaled(16),
        ScrollbarRounding = ImGuiHelpers.GetScaled(9),
        GrabMinSize = ImGuiHelpers.GetScaled(10),
        GrabRounding = ImGuiHelpers.GetScaled(3),
        LogSliderDeadzone = ImGuiHelpers.GetScaled(4),
        TabRounding = ImGuiHelpers.GetScaled(4),
        TabBorderSize = 0,
        ButtonTextAlign = new Vector2(0.5f, 0.5f),
        SelectableTextAlign = new Vector2(0, 0),
        DisplaySafeAreaPadding = ImGuiHelpers.GetScaled(new Vector2(3, 3)),
